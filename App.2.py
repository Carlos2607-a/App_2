...
caracteristicas_por_posicion = {
    ...
    "Defensas": {'Penalty committed':-0.5,'Interceptions':0.55,'Clean sheetsRed cards':-0.3,'Errors lead to goal':-0.65,'Total passes':0.65,'Tackles':1,'Yellow cards:':-0.3,'Goals conceded outside the box':-0.35,'Goals conceded inside the box':-0.4,'Aerial duels won %':0.9,'Total duels won %':1,'Accurate passes %':0.5,'Fouls':-0.4,'Dribbled past':-0.6,'Headed goals':0.9},
