...
caracteristicas_por_posicion = {
    "Delanteros": {'Goals':2.55, 'Headed goals':0.7, 'Total shots':1.5, 'Assists':1.2, 'Big chances created':2.5, 'Was fouled':1,'Set piece conversion %':0.55, 'Accurate passes %':0.6, 'Successful dribbles %':0.5, 'Total duels won %':0.3,'Big chances missed':-0.15},
