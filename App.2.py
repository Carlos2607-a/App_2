...
caracteristicas_por_posicion = {
    "Delanteros": {'Goals':6, 'Headed goals':3, 'Total shots':3, 'Assists':3, 'Big chances created':4, 'Was fouled':1,'Set piece conversion %':1.7, 'Accurate passes %':2, 'Successful dribbles %':1.5, 'Total duels won %':1.1,'Big chances missed':-5},
