...
caracteristicas_por_posicion = {
    "Delanteros": {'Goals':3, 'Headed goals':1, 'Total shots':1, 'Assists':1, 'Big chances created':2.4, 'Was fouled':1,'Set piece conversion %':0.55, 'Accurate passes %':0.6, 'Successful dribbles %':0.5, 'Total duels won %':0.3,'Big chances missed':-0.25},
